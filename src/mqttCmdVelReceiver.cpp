...
//  ros::serialization::Serializer<geometry_msgs::TwistConstPtr>::read(istream, cmd_vel_msg);
...
int main(int argc, char **argv)
{
  ...
  nodeHandle.getParam("/mqttCmdVelReceiver/outputDelayFiles", delayFiles);
  ...
  ros::param::get("/mqttCmdVelReceiver/topicsList",topicsList);
...
//  boost::thread _mqttPingThread(&mqtt_bridge::mqttPingFunction, mqttBridge);
  ...
  int loop_rate = 200;
  ros::param::get("/mqttCmdVelReceiver/loop_rate",loop_rate);
